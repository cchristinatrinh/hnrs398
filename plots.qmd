...
employment_growth <- read_excel("data/bds_data.xlsx", sheet = "Total Employment Growth")
...
suppressWarnings(for (v in variables) {
  ...
  plot_filename <- paste0("interactive_plot_", v, ".html")
  save_html(interactive_plot, plot_filename)
})
