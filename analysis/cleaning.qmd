...
```{r}
summary(lm(info_employment_pc~edu_investment_pc+vc_pc, data=pc_era_1))
summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc, data=pc_era_1)) #best

summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc+bach_degrees_pc, data=pc_era_1))

summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc+patents_pc, data=pc_era_1)) #best

summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc+bach_degrees_pc+patents_pc, data=pc_era_1))
```

```{r}
summary(lm(info_employment_pc~edu_investment_pc+vc_pc, data=pc_era_2))
summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc, data=pc_era_2)) #best

summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc+bach_degrees_pc, data=pc_era_2))

summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc+patents_pc, data=pc_era_2)) #best

summary(lm(info_employment_pc~edu_investment_pc+vc_pc+gdp_per_capita_pc+population_pc+firm_death_pc+bach_degrees_pc+patents_pc, data=pc_era_2))
```
...
ggplot(df_bar, aes(x = reorder(state, -value), y = value, fill = variable)) +
  ...
  labs(
    title = "Top States by Average Education Investment\nand Venture Capital (1996-2020)",
    x = "State",
